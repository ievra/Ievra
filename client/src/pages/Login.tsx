...
import { useAuth, LOGOUT_REASON_KEY } from '@/contexts/AuthContext';
...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (reason === 'timeout') {
      ...
      toast({
        title: language === 'vi' ? 'Phiên đã hết hạn' : 'Session Expired',
        description: language === 'vi'
          ? 'Bạn đã bị đăng xuất tự động do không hoạt động trong 1 giờ. Vui lòng đăng nhập lại để tiếp tục.'
          : 'You were automatically logged out after 1 hour of inactivity. Please log in again to continue.',
        variant: 'destructive',
        duration: 8000,
      });
    }
