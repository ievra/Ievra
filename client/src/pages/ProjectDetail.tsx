      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
        ...
        <div className="aspect-square flex flex-col justify-center px-8 md:px-12 lg:px-16 py-12 md:py-16 overflow-hidden">
          ...
          {(project.location || project.completionYear || project.area || project.category) && (
            <div className="mt-10">
              <p className="text-xs font-light tracking-[0.2em] text-white uppercase mb-4">
              ...
              <div className="space-y-0">
                {[
                  ...
                  <div key={i} className="border-t border-white/15 py-3 flex items-center justify-between gap-4">
                    ...
                    <span className="text-[11px] font-light tracking-[0.12em] text-white/80 uppercase text-right">{row.value}</span>
                  </div>
                ))}
