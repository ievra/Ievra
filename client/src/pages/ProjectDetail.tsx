    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="relative w-full aspect-video mb-0">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12">
          <div>
            <h1 className="font-light tracking-wider text-white uppercase" style={{ fontSize: '48px', lineHeight: '1.2' }} data-testid="text-project-title">
              {project.title}
            </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
        ...
        <div className="md:aspect-square flex flex-col justify-center px-8 md:px-20 lg:px-32 py-12 md:py-16 md:overflow-hidden">
