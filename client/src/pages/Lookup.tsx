  ...
  return (
    <div className="min-h-screen bg-black pt-32 pb-20">
      <div className="px-6 sm:px-10 lg:px-16 mb-12">
        ...
        <p className="text-sm text-white/40 font-light mt-5">
          {isVi
      ...
      <div className="px-6 sm:px-10 lg:px-16">
        ...
        {result && (
          <div className="max-w-[1400px] mx-auto bg-black border border-white/[0.08] divide-y divide-white/[0.07] px-4 sm:px-12 lg:px-16 animate-in fade-in duration-500">
            {/* Client info card */}
            {(() => {
              ...
              return (
                <div className="py-14">
                  <p className="text-lg font-light text-white mb-6 sm:mb-8 tracking-wide uppercase">{isVi ? "Thông tin khách hàng" : "Client Information"}</p>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-6">
                    {[
                      ...
                      <div key={i}>
                        ...
                        <p className="text-sm font-light text-white/75 leading-relaxed break-all">{infoRevealed ? value : hidden}</p>
                      </div>
                    ) : null)}
                  </div>
            ...
            {(() => {
              ...
              return (
                <div className="space-y-10 py-14">
                  <p className="text-lg font-light text-white mb-6 sm:mb-8 tracking-wide uppercase">{isVi ? "Tóm tắt tiến độ" : "Progress Summary"}</p>
            ...
            <div className="py-14">
              <p className="text-lg font-light text-white mb-6 sm:mb-8 tracking-wide uppercase">{isVi ? "Tiến độ" : "Progress"}</p>
              {/* Row 1: Circles */}
            ...
            {(designPhases.length > 0 || constructionPhases.length > 0) && (
              <div className="py-14">
                <p className="text-lg font-light text-white mb-6 sm:mb-8 tracking-wide uppercase">
            ...
            {(() => {
              ...
              return (
                <div className="py-14">
                  <p className="text-lg font-light text-white mb-6 sm:mb-8 tracking-wide uppercase">{isVi ? "Hoạt động gần đây" : "Recent Activity"}</p>
            ...
            <div className="py-14">
              <p className="text-lg font-light text-white mb-6 sm:mb-8 tracking-wide uppercase">{isVi ? "Nhật ký công trình" : "Construction Log"}</p>
              {/* Tab headers */}
              ...
              {(activeTab === "design" || activeTab === "construction") && (() => {
                ...
                return (
                  <div className="py-7 sm:py-8 flex flex-col sm:flex-row sm:items-center gap-5 sm:gap-6">
                    {/* Search input */}
