                  ...
                  >
                    ...
                    <div className="pt-3 pb-3 flex flex-col overflow-hidden" style={{ height: '5.4rem' }}>
                      ...
                      <div className="flex items-center justify-between mt-auto" style={{ height: '1rem' }}>
                        <p className="text-zinc-600 text-[10px] uppercase tracking-widest font-light truncate mr-2">
                          {getCategoryLabel(article.category)}
                        </p>
                        <p className="text-zinc-600 text-[10px] font-light whitespace-nowrap">
                          {[
