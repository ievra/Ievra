                  ...
                  <div className="space-y-2 mb-8">
                    ...
                    <div className="border-2 border-dashed border-muted-foreground/30 rounded-lg overflow-hidden" style={{ height: '168px' }}>
                      {projectOgImagePreview ? (
                        ...
                        <label htmlFor="project-og-image-upload" className={`flex flex-col items-center justify-center gap-2 w-full h-full cursor-pointer ${!hasPermission(user, 'projects') ? 'opacity-50 cursor-not-allowed' : ''}`}>
