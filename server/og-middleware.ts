      ...
      if (!tags) {
        const staticPages: { [key: string]: { en: string; vi: string; titleEn: string; titleVi: string; descEn: string; descVi: string } } = {
          ...
          '/about': {
            ...
            descEn: 'Learn about IEVRA Design & Build – our founding story, design philosophy, and commitment to crafting luxurious, meaningful spaces across Vietnam.',
            descVi: 'Tìm hiểu câu chuyện hình thành, triết lý sáng tạo và cam kết của IEVRA trong việc kiến tạo không gian nội thất sang trọng, tinh tế tại Việt Nam.',
          },
          '/gioi-thieu': {
            en: '/about', vi: '/gioi-thieu',
            titleEn: 'About Us | IEVRA Design & Build',
          ...
          '/portfolio': {
            ...
            descEn: 'Browse IEVRA\'s portfolio of luxury interior design projects in Vietnam. Apartments, villas, restaurants, offices – discover our distinctive signature style.',
            descVi: 'Khám phá danh mục dự án thiết kế nội thất và kiến trúc cao cấp của IEVRA. Căn hộ, biệt thự, nhà hàng, văn phòng – từng công trình mang dấu ấn riêng.',
          },
          '/du-an': {
            en: '/portfolio', vi: '/du-an',
            titleEn: 'Portfolio | IEVRA Design & Build',
          ...
          '/blog': {
            ...
            descEn: 'Interior design insights, trends & expert tips from IEVRA. Stay updated with the latest styles, materials, and inspiration for your dream home or office.',
            descVi: 'Kiến thức chuyên sâu về thiết kế nội thất, xu hướng mới nhất và cảm hứng sáng tạo từ IEVRA. Cập nhật phong cách, vật liệu và giải pháp không gian sống.',
          },
          '/tin-tuc': {
            en: '/blog', vi: '/tin-tuc',
            titleEn: 'Blog | IEVRA Design & Build',
          ...
          '/contact': {
            ...
            descEn: 'Contact IEVRA Design & Build for a free interior design consultation. Premium design & build services for homes, villas, and commercial spaces across Vietnam.',
            descVi: 'Liên hệ IEVRA Design & Build để được tư vấn thiết kế nội thất miễn phí. Dịch vụ thiết kế và thi công trọn gói cho căn hộ, biệt thự và không gian thương mại.',
          },
          '/lien-he': {
            en: '/contact', vi: '/lien-he',
            titleEn: 'Contact Us | IEVRA Design & Build',
          ...
          '/lookup': {
            ...
            descEn: 'Track your IEVRA project progress in real time. Enter your project code to view status updates, timelines, and key milestones for your interior design project.',
            descVi: 'Tra cứu tiến độ thi công và thiết kế dự án theo thời gian thực. Nhập mã dự án để xem trạng thái, lịch trình và các mốc hoàn thành quan trọng của dự án.',
          },
          '/tra-cuu': {
            en: '/lookup', vi: '/tra-cuu',
            titleEn: 'Project Lookup | IEVRA Design & Build',
